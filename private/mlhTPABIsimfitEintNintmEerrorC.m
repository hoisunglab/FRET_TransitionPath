function [errorparams logmlhres dellogmlh]=mlhTPABIsimfitEintNintmEerrorC(initparams,effb,resparamfix,onet3rkk,stateid,fitfu,nintm,drvintv,drvpnt)
%
% [errorparams logmlhres dellogmlh] = mlhTPABIsimfitEintNintmEerrorC(initparams,effb,resparamfix,onet3rkk,stateid,fitfu,nintm,drvintv,drvpnt)
%
% Calculate errors (standard deviation) of the parameter determined by mlhTPABIsimfitEintNintmEC.m.  
% Outputs are parameter errors, log likelihood value, and log likelihood value difference from an instantaneous transition model
% calculated using the optimized parameters.
