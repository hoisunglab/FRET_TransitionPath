function [errorparams logmlhres]=mlhTPABIsimfit0errorC(initparams,effb,resparamfix,onet3rkk,stateid,fitfu,nintm,isincE,drvintv,drvpnt)
%
% [errorparams logmlhres] = mlhTPABIsimfit0errorC(initparams,effb,resparamfix,onet3rkk,stateid,fitfu,nintm,isincE,drvintv,drvpnt)
%
% Calculate errors (standard deviation) of the parameter determined by mlhTPABIsimfit0C.m.  
% Outputs are parameter errors and log likelihood value calculated using optimized parameters.
...
if initparamsA(end) > 0.5, initparamsA(end)=1-initparamsA(end); end     % pb
